...
function findAIProduct(question) {
  ...
  const exactMatches =
    allProducts.filter(product => {
      ...
      return (
        (th && compact.includes(th)) ||
        (en && compact.includes(en))
      );
...
// ========================================
// FILTER MOVEMENTS BY RANGE
// ========================================

function filterAIMovementsByRange(
  movements,
  range
) {
...
function getAIProductMovementSummary(
  rows,
  product
) {
